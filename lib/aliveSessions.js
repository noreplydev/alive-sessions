...
const createSession = (config) => {
  ...
  const newSession = new Session(sessionID, expireMs, action, data, sessionsTable)
...
const removeSession = sessionID => {
  ...
  sessionsTable.removeSession(sessionID)
}
...
const getSessionData = sessionID => {
  ...
  return sessionsTable.getSessionData(sessionID)
}
...
const sessions = () => sessionsTable.getSessions()
